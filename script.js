document.addEventListener('DOMContentLoaded', function() {
  ...
  // Add animated class style handling
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מזי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f70cb181-a137-49e6-a691-4a470f280c18',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f70cb181-a137-49e6-a691-4a470f280c18';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f70cb181-a137-49e6-a691-4a470f280c18';
